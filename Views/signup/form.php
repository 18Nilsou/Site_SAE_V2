<form class="signForm" method="post" action="signup/register">
    ...
    <input type="password" placeholder="Rentrez votre mot de passe" class="input" name="password" title="Au moins 12 caractères, un chiffre, une lettre majuscule, une minuscule et un caractère spécial" required >
