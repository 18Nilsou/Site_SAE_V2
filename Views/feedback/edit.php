...
<form class="signForm" method="post" action="/feedback/edit">
    <h2 class="form-title">Modifier le commentaire</h2>
    ...
    <input class="id-form-input" type="number" name="rating" max="5" min="0" value="<?php echo($A_view["rating"]) ?>" required><br>
